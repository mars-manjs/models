...
export type modelClass = new (...args: any[]) => BaseDataModel;
export interface child_i { key: string, model: modelClass }


export type repoConfig = BaseRepository | repoMainMap_i
export type formConfig = BaseFormModel  | formMainMap_i